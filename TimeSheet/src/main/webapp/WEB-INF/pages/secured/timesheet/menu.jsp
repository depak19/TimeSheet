<div class="container-fluid">
	...
	<div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
		<ul class="nav navbar-nav">
			<li class="active"><a href="userLanding.do">Home<span
					style="font-size: 16px;"
					class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
			<li class="dropdown"><a href="#" class="dropdown-toggle"
				data-toggle="dropdown">Time Sheet <span class="caret"></span><span
					style="font-size: 16px;"
					class="pull-right hidden-xs showopacity glyphicon glyphicon-user"></span></a>
				<ul class="dropdown-menu forAnimate" role="menu">
					<li><a href="ote.do">Time Sheet</a></li>
					<li><a href="#">Time Sheet Report</a></li>
					<li><a href="#">Missing Time Sheet</a></li>
					<li class="divider"></li>
					<li><a href="#">Faq</a></li>
					<li class="divider"></li>
					<li><a href="#">OTE UPK</a></li>
				</ul></li>
